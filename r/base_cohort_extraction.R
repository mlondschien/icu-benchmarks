...
base_static_vars <- c("patient_id", "death_icu", "los_hosp", "los_icu", "ed_disposition", "hospital_id", "year", "carevue", "metavision", "icd9_diagnosis", "icd10_diagnosis", "ward", "insurance")
