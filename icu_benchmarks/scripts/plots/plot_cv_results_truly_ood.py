...
from icu_benchmarks.plotting import COLORS, DATASET_NAMES, METRIC_NAMES, PARAMETER_NAMES
import json
...
def main(tracking_uri, config):  # noqa D
    ...
    fig, axes = plt.subplots(
        2, 2, figsize=(12, 8), constrained_layout=True, gridspec_kw={"hspace": 0.02}
    )
    ...
    for line in CONFIG["lines"]:
        ...
        cv_results = results_n0.join(cv_results, on=params, how="full", validate="1:1")
